...
This will use up significantly more memory and computational power. Globals in your program will not be available in any other program. [This shouldn't matter anyway since you shouldn't be setting globals](intro/faq.md#what-are-bad-practices-to-avoid).
...
Module requires certain exports. Read more [here](intro/making-app.md#module-exports).
