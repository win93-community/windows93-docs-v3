...
For higher-level file operations, see the [`actions`](/docs/api/actions) module.
...
:::tip
View the [driver internals page](../internals/indexeddb) to learn more about mount configuration.
:::
...
Some methods forward extra arguments to the active driver, so exact parameter and return shapes can vary.
...
:::tip
[View the events reference](../guide/events) for more information on event handling.
:::
